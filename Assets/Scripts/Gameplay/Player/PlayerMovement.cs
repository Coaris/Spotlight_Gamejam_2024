...
public class PlayerMovement : MonoBehaviour {
        ...
        private void Run(float lerpAmount) {
                ...
                //根据我们是加速（包括转向）还是尝试减速（停止）来获取加速度值；如果角色在空中，还会应用一个乘数。
                ...
                #region 添加跳跃顶点加速度
                //在跳跃的最高点增加加速度和最大速度，使跳跃感觉更加有弹性、灵敏和自然。
		...
		*/
        ...
        private void WallJump(int dir) {
                ...
                if (RB.velocity.y < 0) //检查玩家是否正在下落，如果是的话，我们减去 velocity.y（抵消重力的作用力）。这确保玩家始终达到我们期望的跳跃力或更大。
